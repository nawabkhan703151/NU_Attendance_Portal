...
const AddBatch = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:4000/batch/uploadBatchExcel', formData, {
      ...
      if (inserted === 0 && failed === 0) {
        ...
        setSuccess(`Batches inserted successfully! Total Inserted: ${inserted}, Failed: ${failed}`);
        setError('');
      }
    ...
    <div className="add-student-container">
      <div className="sidebar">
        ...
        <nav className="nav-list">
          ...
          <a href="/admin/add-batch" className="nav-link">
            <span className="link-icon"><FaList /></span> Add Batches
          </a>
        </nav>
      </div>
      ...
      <div className="main-content">
        <div className="upload-section">
          <h2 className="section-title">Upload Batch Excel File</h2>
