...
import '../../Styles/Admin/AddSession.css';
...
const AddSession = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:4000/session/uploadSessionExcel', formData, {
    ...
    <div className="add-student-container">
      ...
      <div className="main-content">
        <div className="upload-section">
          <h2 className="section-title">Upload Session Excel File</h2>
